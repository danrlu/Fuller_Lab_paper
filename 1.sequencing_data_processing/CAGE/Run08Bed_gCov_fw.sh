...
-d -5 -strand + > B1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt

bedtools genomecov -i ../B2_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed \
-g ../dm6.ucsc.chrom.sizes \
-d -5 -strand + > B2_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt

bedtools genomecov -i ../H1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed \
-g ../dm6.ucsc.chrom.sizes \
-d -5 -strand + > H1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt

bedtools genomecov -i ../H2_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed \
-g ../dm6.ucsc.chrom.sizes \
-d -5 -strand + > H2_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt
